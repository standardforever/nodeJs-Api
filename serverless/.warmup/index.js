...
const functions = [
  ...
  {
    "name": "finest50-dev-forgetPassword",
    "config": {
      "enabled": true,
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
      "concurrency": 1
  ...
  {
    "name": "finest50-dev-resetPassword",
    "config": {
      "enabled": true,
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
      "concurrency": 1
  ...
  {
    "name": "finest50-dev-fireBaseGoogle",
    "config": {
      "enabled": true,
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
      "concurrency": 1
  ...
  {
    "name": "finest50-dev-checkVerified",
    "config": {
      "enabled": true,
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
      "concurrency": 1
  ...
  {
    "name": "finest50-dev-personalInfo",
    "config": {
      "enabled": true,
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
      "concurrency": 1
  ...
  {
    "name": "finest50-dev-getPersonalInfo",
    "config": {
      "enabled": true,
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
      "concurrency": 1
  ...
  {
    "name": "finest50-dev-professionalInfo",
    "config": {
      "enabled": true,
      "payload": "{\"source\":\"serverless-plugin-warmup\"}",
      "concurrency": 1
